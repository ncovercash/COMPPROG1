...
public class Cacalatur extends ActiveObject {
				...
				switch (b.getBID2()) {
					case 0:
						if (calculateInput() != top.getScore()) {
							mem+=top.getScore();
							tapeEntries.add("mem + "+top.getScore()+" = "+mem);
						} else {
							mem+=calculateInput();
							tapeEntries.add("mem + "+calculateInput()+" = "+mem);
						}
						updateTape();
						break;
					case 1:
					...
					case 6:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(1/top.getScore() * 100000000d) / 100000000d);
					...
					case 7:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.pow(top.getScore(), 2) * 100000000d) / 100000000d);
					...
					case 8:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.sqrt(top.getScore()) * 100000000d) / 100000000d);
						tapeEntries.add("√("+val1+") = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					...
					case 10:
						...
						top.setScore((double)Math.round(result * 100000000d) / 100000000d);
					...
					case 12:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.floor(top.getScore()) * 100000000d) / 100000000d);
					...
					case 13:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.ceil(top.getScore()) * 100000000d) / 100000000d);
					...
					case 14:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round((top.getScore()+1) * 100000000d) / 100000000d);
						tapeEntries.add(val1+"++ = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					...
					case 16:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.round(top.getScore()) * 100000000d) / 100000000d);
					...
					case 17:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.pow(Math.E, top.getScore()) * 100000000d) / 100000000d);
					...
					case 18:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.sin(Math.toRadians(val1)) * 100000000d) / 100000000d);
					...
					case 19:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.cos(Math.toRadians(val1)) * 100000000d) / 100000000d);
					...
					case 20:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.tan(Math.toRadians(val1)) * 100000000d) / 100000000d);
					...
					case 27:
						inputs = new ArrayList<String>();
						top.setScore((double)Math.round(Math.E * 100000000d) / 100000000d);
						break;
					case 28:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.pow(10, top.getScore()) * 100000000d) / 100000000d);
					...
					case 29:
						...
						if (op != -1) {
							switch(op) {
								...
								case 29:
									val2 = calculateInput();
									val2 = (double)Math.round(val2 * 100000000d) / 100000000d;
									result = val1/val2;
					...
					case 30:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.log10(top.getScore()) * 100000000d) / 100000000d);
					...
					case 31:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.log(top.getScore()) * 100000000d) / 100000000d);
					...
					case 42:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.pow(top.getScore(), 3) * 100000000d) / 100000000d);
						tapeEntries.add(val1+"³ = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					case 43:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.cbrt(top.getScore()) * 100000000d) / 100000000d);
						tapeEntries.add("∛("+val1+") = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					...
					case 48:
						val1 = top.getScore();
						val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
						top.setScore((double)Math.round(Math.abs(top.getScore()) * 100000000d) / 100000000d);
					...
					case 55:
						if ((int)top.getScore() == top.getScore()) {
							val1 = top.getScore();
							val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
							top.setScore((double)Math.round(1 * 100000000d) / 100000000d);
							...
							val1 = top.getScore();
							val1 = (double)Math.round(val1 * 100000000d) / 100000000d;
							top.setScore((double)Math.round(0 * 100000000d) / 100000000d);
	...
	public void updateDisplay() {
		top.setScore((double)Math.round(calculateInput() * 100000000d) / 100000000d);
	}
	...
	public static String parseToCientificNotation(double value) {
		...
		return df.format(value).replace(",", ".") + " x10^" + cont;
	}
}