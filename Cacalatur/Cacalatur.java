		...
		for (Button b:buttons) {
			if (b.testClick(p)) {
				...
				switch (b.getBID2()) {
					...
					case 7:
						val1 = top.getScore();
						top.setScore(Math.pow(top.getScore(), 2));
					...
					case 8:
						val1 = top.getScore();
						top.setScore(Math.sqrt(top.getScore()));
						tapeEntries.add("√("+val1+") = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					...
					case 12:
						val1 = top.getScore();
						top.setScore(Math.floor(top.getScore()));
					...
					case 13:
						val1 = top.getScore();
						top.setScore(Math.ceil(top.getScore()));
					...
					case 16:
						val1 = top.getScore();
						top.setScore(Math.round(top.getScore()));
					...
					case 17:
						val1 = top.getScore();
						top.setScore(Math.pow(Math.E, top.getScore()));
					...
					case 18:
						val1 = top.getScore();
						top.setScore(Math.sin(Math.toRadians(val1)));
					...
					case 19:
						val1 = top.getScore();
						top.setScore(Math.cos(Math.toRadians(val1)));
					...
					case 20:
						val1 = top.getScore();
						top.setScore(Math.tan(Math.toRadians(val1)));
					...
					case 28:
						val1 = top.getScore();
						top.setScore(Math.pow(10, top.getScore()));
					...
					case 30:
						val1 = top.getScore();
						top.setScore(Math.log10(top.getScore()));
					...
					case 31:
						val1 = top.getScore();
						top.setScore(Math.log(top.getScore()));
					...
					case 42:
						val1 = top.getScore();
						top.setScore(Math.pow(top.getScore(), 3));
						tapeEntries.add(val1+"³ = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					case 43:
						val1 = top.getScore();
						top.setScore(Math.cbrt(top.getScore()));
						tapeEntries.add("∛("+val1+") = "+top.getScore());
						updateTape();
						inputs = new ArrayList<String>();
						break;
					...
					case 48:
						val1 = top.getScore();
						top.setScore(Math.abs(top.getScore()));
